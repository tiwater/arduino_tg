...
void do_spi_flash_chip_erase_func(void *param);

void do_spi_flash_read_func(void *param);

void do_spi_flash_read_reg_func(void *param);

void do_spi_flash_erase_security_area_func(void *param);

void do_spi_flash_program_security_area_func(void *param);

void do_spi_flash_read_security_area_func(void *param);

void do_spi_flash_prog_func(void *param);
