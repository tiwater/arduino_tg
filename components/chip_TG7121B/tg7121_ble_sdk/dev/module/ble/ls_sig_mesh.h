...
#define VENDOR_USER_SERVER               (0x093A0000) /*!< Vendor Model Index of linkedsemi server 0x093A0000*/
#define VENDOR_USER_CLIENT               (0x093A0001)  /*!< Vendor Model Index of linkedsemi client 0x093A0001*/
...
// linkedsemi Vendor        
#define APP_LS_SIG_MESH_VENDOR_SET          (0x00093Ac1)  /*!< Vendor opcdoe of linkedsemi set 0x00093Ac1*/
#define APP_LS_SIG_MESH_VENDOR_SET_UNAK     (0x00093Ac2)  /*!< Vendor opcdoe of linkedsemi set unacknowleged 0x00093Ac2*/
#define APP_LS_SIG_MESH_VENDOR_STATUS       (0x00093Ac3)  /*!< Vendor opcdoe of linkedsemi status 0x00093Ac3*/
#define APP_LS_SIG_MESH_VENDOR_INDICATION   (0x00093Ac4)  /*!< Vendor opcdoe of linkedsemi indication 0x00093Ac4*/
#define APP_LS_SIG_MESH_VENDOR_CONFIRMATION (0x00093Ac5)  /*!< Vendor opcdoe of linkedsemi confirmation 0x00093Ac5*/
