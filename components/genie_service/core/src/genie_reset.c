...
int genie_reset_provision(void)
{
    ...
    bt_mesh_adv_stop();
#if !defined(CONFIG_BT_SETTINGS) || defined(CONFIG_PM_SLEEP)
...
#if defined(CONFIG_GENIE_SW_RESET_PROV) && !defined(CONFIG_PM_SLEEP)
#ifdef CONFIG_GENIE_OTA
    genie_ais_deinit();
#endif

#ifdef CONFIG_GENIE_ULTRA_PROV
    genie_ultra_prov_init();
#endif
...
static int reset_report_result_cb(void *p_params, transport_result_e result_e)
{
