...
#define VENDOR_OP_ATTR_HB_REPORT 0xDD

#define ATTR_TYPE_REPORT_VERSION 0xFF01
#define ATTR_TYPE_DEVICE_EVENT 0xF009

#define ATTR_TYPE_VOLTAGE_LEVEL 0x0105
#define ATTR_TYPE_BATTERY_STATUS 0x0549

#define GENIE_BATTERY_STATUS_LOW (0x00)
#define GENIE_BATTERY_STATUS_NORMAL (0x01)
#define GENIE_BATTERY_STATUS_CHARGING (0x03)
