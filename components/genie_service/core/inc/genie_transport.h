...
#ifndef GENIE_TRANSPORT_DEFAULT_TTL
#ifdef CONFIG_BT_MESH_NPS_OPT
#define GENIE_TRANSPORT_DEFAULT_TTL (5)
#else
#define GENIE_TRANSPORT_DEFAULT_TTL (7)
#endif
#endif
...
typedef int (*transport_result_cb)(void *p_params, transport_result_e result);
