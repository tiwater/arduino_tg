...
#if defined  CONFIG_DW_UART_DMAC
__attribute__((section(".__sram.code")))  static void dw_usart_dma_event_cb(int32_t ch, dma_event_e event, void *arg)
{
...
__attribute__((section(".__sram.code"))) int32_t csi_usart_restart_receive_dma(usart_handle_t handle)
{
    dw_usart_priv_t *usart_priv = handle;
    dw_usart_reg_t *addr = (dw_usart_reg_t *)(usart_priv->base);
