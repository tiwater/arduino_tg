...
mkdir -p ${MK_GENERATED_IMGS_PATH}/data_tmp/
...
cp ${CUR_BOARD_PATH}/bootimgs/old/boot ${MK_GENERATED_IMGS_PATH}/data_tmp/
cp ${CUR_BOARD_PATH}/bootimgs/old/bomtb ${MK_GENERATED_IMGS_PATH}/data_tmp/
cp ${CUR_BOARD_PATH}/configs/config.yaml ${MK_GENERATED_IMGS_PATH}/data_tmp/
